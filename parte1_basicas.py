...
def es_recomendada(duracion, rating):
    dur_clase = clasificar_duracion(duracion)
    rat_clase = clasificar_rating(rating)
    return (rat_clase in ["buena", "excelente"]) and (dur_clase in ["estándar", "corta"])
